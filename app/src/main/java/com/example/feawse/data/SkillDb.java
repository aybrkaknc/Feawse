...
import com.example.feawse.savefile.units.extrablock.RawParent;
    ...
    public void readSkills() {
        ...
        try {
            ...
            if (file != null && file.exists()) is = new FileInputStream(file);
                ...
                is = com.example.feawse.util.ResourceHelper.getStream(SkillDb.class, xmlFilePath, "database/skills.xml");
