package com.example.feawse.data;

import com.example.feawse.FireEditor;
import com.example.feawse.data.model.EinherjarModel;
import com.example.feawse.data.model.UnitModel;
    ...
    public void readUnits() {
        ...
        try {
            ...
            if (file != null && file.exists()) is = new FileInputStream(file);
                ...
                is = com.example.feawse.util.ResourceHelper.getStream(UnitDb.class, xmlFilePath, "database/units.xml");
                if (is == null) throw new FileNotFoundException("Resource not found: " + xmlFilePath);
            }

            Document document = com.example.feawse.util.XmlHelper.parseXml(is);
    ...
    public void readEinherjar() {
        ...
        try {
            ...
            if (file != null && file.exists()) is = new FileInputStream(file);
                ...
                is = com.example.feawse.util.ResourceHelper.getStream(UnitDb.class, xmlFilePath, "database/einherjar.xml");
                if (is == null) throw new FileNotFoundException("Resource not found: " + xmlFilePath);
            }
