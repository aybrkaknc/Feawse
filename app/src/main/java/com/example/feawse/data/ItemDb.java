...
import com.example.feawse.savefile.units.mainblock.RawItem;
    ...
    public void readItems() {
        ...
        try {
            ...
            if (file != null && file.exists()) is = new FileInputStream(file);
                ...
                is = com.example.feawse.util.ResourceHelper.getStream(ItemDb.class, xmlFilePath, "database/items.xml");
