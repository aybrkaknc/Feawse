...
import com.example.feawse.data.model.ChapterModel;
    ...
    public void readChapters() {
        ...
        try {
            ...
            if (file != null && file.exists()) is = new FileInputStream(file);
                ...
                is = com.example.feawse.util.ResourceHelper.getStream(ChapterDb.class, xmlFilePath, "database/chapters.xml");
