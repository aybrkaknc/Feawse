package com.example.feawse.savefile.units.extrablock;
...
public class LogBlock {
    ...
    public LogBlock() {
        ...
        InputStream is = com.example.feawse.util.ResourceHelper.getStream(LogBlock.class, path, "templates/blocks/rawUnitLog");
        if (is != null) {
            try {
