...
import com.example.feawse.data.model.ClassModel;
import com.example.feawse.data.model.ItemModel;
...
import static com.example.feawse.data.UnitDb.getUnitAddition;
import static com.example.feawse.data.UnitDb.getUnitModifiers;
...
public class Stats {
    ...
    public static void setGodModeStats(Unit unit) {
        for (int i = 0; i < 8; i++) {
            unit.rawBlock1.setGrowth(80, i);
        }
        unit.rawBlock1.setCurrentHp(99);
        unit.rawBlock1.setLevel(20);
        unit.rawBlock1.setExp(99);
        unit.rawBlock2.setMaxWeaponExp();
        unit.rawBlock1.setMovement(2);
        unit.rawFlags.setHiddenLevel(200);
    }
